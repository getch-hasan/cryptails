    ...
    <section className="bg-white py-12 px-6 lg:px-24 flex flex-col lg:flex-row items-center">
      ...
      <div className="w-full lg:w-1/2 lg:pl-12">
        ...
        <h2 className="text-3xl lg:text-4xl font-bold mb-4">
          We Were Founded In The 90&apos;s
          <br />
          Innovate For The Better
        </h2>
        <p className="text-gray-600 mb-6">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis ex
          quod perspiciatis accusamus maxime iis ex quod perspiciatis accusamus
          maxime ommo nditiis ex quod perspiciatis accusamus maxime omm
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="flex items-start space-x-3 border border-orange-200 rounded p-4">
            ...
            <div>
              <h4 className="font-semibold">Friendly Price</h4>
